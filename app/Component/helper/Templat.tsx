...
export default function Templat({title,color,background,colorOpp,backgroundOpp,link,des}:props) {
  return (
    <div className={`${background}  pt-14 pb-14 px-5 text-center mb-14`}>
